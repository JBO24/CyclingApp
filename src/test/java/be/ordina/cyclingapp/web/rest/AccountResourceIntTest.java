...
import be.ordina.cyclingapp.config.Constants;
import be.ordina.cyclingapp.CyclingApp;
import be.ordina.cyclingapp.domain.Authority;
import be.ordina.cyclingapp.domain.User;
import be.ordina.cyclingapp.repository.AuthorityRepository;
import be.ordina.cyclingapp.repository.UserRepository;
import be.ordina.cyclingapp.security.AuthoritiesConstants;
import be.ordina.cyclingapp.service.MailService;
import be.ordina.cyclingapp.service.dto.UserDTO;
import be.ordina.cyclingapp.web.rest.errors.ExceptionTranslator;
import be.ordina.cyclingapp.web.rest.vm.KeyAndPasswordVM;
import be.ordina.cyclingapp.web.rest.vm.ManagedUserVM;
import be.ordina.cyclingapp.service.UserService;
