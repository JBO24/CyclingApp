...
import be.ordina.cyclingapp.domain.Team;
import be.ordina.cyclingapp.repository.TeamRepository;
...
public class TeamResourceIntTest {
    ...
    private static final String DEFAULT_TEAM_MANAGER = "AAAAAAAAAA";
    private static final String UPDATED_TEAM_MANAGER = "BBBBBBBBBB";

    private static final String DEFAULT_BRAND_OF_BICYCLE = "AAAAAAAAAA";
    private static final String UPDATED_BRAND_OF_BICYCLE = "BBBBBBBBBB";
    ...
    public static Team createEntity(EntityManager em) {
        Team team = new Team()
            ...
            .teamManager(DEFAULT_TEAM_MANAGER)
            .brandOfBicycle(DEFAULT_BRAND_OF_BICYCLE);
        return team;
    }
    ...
    public void createTeam() throws Exception {
        ...
        assertThat(testTeam.getAmountOfVictories()).isEqualTo(DEFAULT_AMOUNT_OF_VICTORIES);
        assertThat(testTeam.getYearFounded()).isEqualTo(DEFAULT_YEAR_FOUNDED);
        assertThat(testTeam.getTeamManager()).isEqualTo(DEFAULT_TEAM_MANAGER);
        assertThat(testTeam.getBrandOfBicycle()).isEqualTo(DEFAULT_BRAND_OF_BICYCLE);
    }
    ...
    public void getAllTeams() throws Exception {
        ...
        restTeamMockMvc.perform(get("/api/teams?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].teamManager").value(hasItem(DEFAULT_TEAM_MANAGER.toString())))
            .andExpect(jsonPath("$.[*].brandOfBicycle").value(hasItem(DEFAULT_BRAND_OF_BICYCLE.toString())));
    }
    ...
    public void getTeam() throws Exception {
        ...
        restTeamMockMvc.perform(get("/api/teams/{id}", team.getId()))
            ...
            .andExpect(jsonPath("$.teamManager").value(DEFAULT_TEAM_MANAGER.toString()))
            .andExpect(jsonPath("$.brandOfBicycle").value(DEFAULT_BRAND_OF_BICYCLE.toString()));
    }
    ...
    public void updateTeam() throws Exception {
        ...
        updatedTeam
            ...
            .teamManager(UPDATED_TEAM_MANAGER)
            .brandOfBicycle(UPDATED_BRAND_OF_BICYCLE);
        ...
        assertThat(testTeam.getAmountOfVictories()).isEqualTo(UPDATED_AMOUNT_OF_VICTORIES);
        assertThat(testTeam.getYearFounded()).isEqualTo(UPDATED_YEAR_FOUNDED);
        assertThat(testTeam.getTeamManager()).isEqualTo(UPDATED_TEAM_MANAGER);
        assertThat(testTeam.getBrandOfBicycle()).isEqualTo(UPDATED_BRAND_OF_BICYCLE);
    }
