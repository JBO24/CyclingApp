...
import be.ordina.cyclingapp.config.audit.AuditEventConverter;
import be.ordina.cyclingapp.domain.PersistentAuditEvent;
...
import static be.ordina.cyclingapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
